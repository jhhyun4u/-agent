...
export const STEP_MAP = {
  ...
  proposal_customer_analysis: { step: 3, label: "고객분석" },
  plan_story: { step: 3, label: "제안계획" },
  plan_team: { step: 3, label: "제안계획" },
  plan_assign: { step: 3, label: "제안계획" },
  plan_schedule: { step: 3, label: "제안계획" },
  proposal_write_next: { step: 4, label: "제안서작성" },
  section_quality_check: { step: 4, label: "제안서작성" },
  storyline_gap_analysis: { step: 4, label: "제안서작성" },
  self_review: { step: 4, label: "제안서작성" },
  presentation_strategy: { step: 5, label: "PPT" },
  ppt_toc: { step: 5, label: "PPT" },
  ppt_visual_brief: { step: 5, label: "PPT" },
  ppt_storyboard: { step: 5, label: "PPT" },
  mock_evaluation: { step: 6, label: "모의평가" },
