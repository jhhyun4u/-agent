...
function deriveStatus(p: ProposalSummary): { label: string; dotColor: string; textColor: string; tooltip: string } {
  if (p.status === "failed") return { label: "실패", dotColor: "bg-red-400", textColor: "text-red-400", tooltip: "워크플로 실패" };
  if (p.status === "completed") return { label: "완료", dotColor: "bg-emerald-400", textColor: "text-emerald-400", tooltip: "제안서 완료" };
