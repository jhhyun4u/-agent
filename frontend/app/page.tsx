  ...
  return (
    <>
      <style jsx global>{`
        ...
        .l-flow-step + .l-flow-step {
          border-left: none;
        }
        .l-flow-step:first-child {
          border-radius: 12px 0 0 12px;
        }
        .l-flow-step:last-child {
        ...
        @media (max-width: 900px) {
          ...
          .l-flow-step:nth-child(2) {
            border-radius: 0 12px 0 0;
          }
          .l-flow-step:nth-child(3) {
      ...
      <div className="landing">
        ...
        <nav className="l-nav">
          ...
          <div className="l-nav-right">
            ...
            <span className="l-nav-links">
              <a href="#preview" className="l-nav-link">
                화면 미리보기
              </a>
            </span>
          </div>
          ...
          <div className="l-hero">
            <div className="l-hero-copy">
              <div className="l-hero-eyebrow">
                ...
                {s
                  ? `오늘 신규 공고 ${s.today_new_bids}건 수집 완료`
                  : "실시간 공고 수집 중..."}
              </div>
              <h1>
                나라장터 공고부터
              ...
              <p>
                TENOPA 임직원 전용 R&D 수주 자동화 플랫폼. 공고 모니터링, AI
                스크리닝, 제안서 초안 생성을 한 번에 처리하세요.
              </p>
            ...
            <div className="l-hero-card">
              ...
              <div className="hc-row">
                ...
                <span className="hc-val">
                  {s ? `${s.today_new_bids}건` : "-"}
                </span>
              </div>
              <div className="hc-row">
                <span className="hc-lbl">AI 추천 공고</span>
                <span className="hc-val">
                  {s ? `${s.today_recommended}건` : "-"}
                </span>
              </div>
              <div className="hc-row">
                <span className="hc-lbl">마감 임박 D-3</span>
                <span className="hc-val-red">
                  {s ? `${s.deadline_urgent}건` : "-"}
                </span>
              </div>
              <div className="hc-row">
                <span className="hc-lbl">이번달 제안</span>
                <span className="hc-val-green">
                  {s ? `${s.monthly_proposals}건` : "-"}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="l-stats-strip">
          <div className="l-stat-cell">
            <div className="l-stat-num">
              {s ? s.daily_bids_monitored.toLocaleString() : "-"}
            </div>
            <div className="l-stat-lbl">누적 모니터링 공고 수</div>
          </div>
          <div className="l-stat-cell">
            <div className="l-stat-num">
              {s ? `${s.screening_accuracy_pct}%` : "-"}
            </div>
              ...
              {[
                {
                  ...
                  ico: "\uD83D\uDD0D",
                  title: "공고 자동 수집\u00B7분류",
                  desc: "나라장터 전 부처 공고를 1시간마다 수집. 기술 분야\u00B7금액\u00B7기간 기준으로 자동 태깅합니다.",
                },
                {
                  num: 2,
                  ico: "\uD83E\uDD16",
                  title: "AI 수주 가능성 스코어링",
                  desc: "보유 이력\u00B7인력\u00B7전문 분야와 공고를 매칭해 수주 가능성 점수를 즉시 산정합니다.",
                },
                {
                  num: 3,
                  ico: "\u270D\uFE0F",
                  title: "제안서 초안 자동 생성",
                  desc: "RFP를 자동 파싱해 수행 방법론\u00B7투입 인력\u00B7추진 일정을 공문서 형식으로 즉시 초안 작성합니다.",
                },
                {
                  num: 4,
                  ico: "\uD83D\uDCC8",
                  title: "제출\u00B7성과 관리",
                  desc: "낙찰\u00B7탈락 피드백을 축적해 다음 제안의 승률을 지속적으로 개선합니다.",
                },
              ].map((step, i, arr) => (
                <div className="l-flow-step" key={step.num}>
                  ...
                  {i < arr.length - 1 && (
                    <div className="l-step-arr">&rarr;</div>
                  )}
                </div>
              ))}
            </div>
              ...
              {[
                {
                  ico: "\uD83D\uDCE1",
                  title: "실시간 공고 알림",
                  desc: "키워드\u00B7부처\u00B7금액 조건으로 맞춤 알림 설정. 마감 D-7\u00B7D-3\u00B7D-1 자동 리마인더를 Teams\u00B7이메일로 수신합니다.",
                  pill: "모니터링",
                },
                {
                  ico: "\uD83D\uDCCA",
                  title: "AI 수주 가능성 스코어",
                  desc: "유사 수행 이력, 요구 자격, 경쟁 강도를 종합 분석. 70점 이상 공고만 집중해 리소스를 최적화합니다.",
                  pill: "AI 분석",
                },
                {
                  ico: "\u270D\uFE0F",
                  title: "제안서 AI 초안 생성",
                  desc: "공고 RFP를 파싱해 목차\u00B7수행 방법\u00B7추진 일정을 포함한 한국어 공문서 초안을 즉시 생성합니다.",
                  pill: "생성형 AI",
                },
                {
                  ico: "\uD83D\uDCDA",
                  title: "과제 레퍼런스 라이브러리",
                  desc: "수행 과제의 제안서\u00B7결과보고서를 RAG 기반으로 검색해 유사 사례를 즉시 참조합니다.",
                  pill: "RAG 검색",
                },
                {
                  ico: "\uD83D\uDC65",
                  title: "팀 협업 & 버전 관리",
                  desc: "제안서 버전 관리, 코멘트 기능, 결재 라인 관리로 팀 전체가 효율적으로 협력합니다.",
                  pill: "협업",
                },
                {
                  ico: "\uD83D\uDCC8",
                  title: "수주 성과 애널리틱스",
                  desc: "부처별\u00B7분야별 수주율, 평균 제안 금액, 경쟁사 동향을 시각화해 전략 수립에 활용합니다.",
                  pill: "애널리틱스",
                },
              ].map((f) => (
          ...
          <div className="l-section">
            ...
            <div className="l-preview-grid">
              <div className="l-preview-copy">
                ...
                <p>
                  매일 아침 대시보드를 열면 신규 공고 현황, AI 추천 공고, 마감
                  임박 알림이 즉시 보입니다.
                </p>
                <ul className="l-check-list">
                  {[
                    ...
                    <li key={t}>
                      <span className="l-check-mark">&#10003;</span>
                      {t}
                    </li>
                  ))}
                </ul>
                ...
                <div className="l-mock-body">
                  <div className="l-mock-kpis">
                    ...
                    <div className="l-mk">
                      ...
                      <div className="l-mk-val" style={{ color: "#FF8A8A" }}>
                        {s?.deadline_urgent ?? "-"}
                      </div>
                      <div className="l-mk-sub" style={{ color: "#FF8A8A" }}>
                        긴급
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="l-mock-row">
                    ...
                    <div>
                      <span className="l-sc l-sc-h">88점</span>
                    </div>
                  </div>
                  <div className="l-mock-row">
                    <div>
                    ...
                    <div>
                      <span className="l-sc l-sc-h">82점</span>
                    </div>
                  </div>
                  <div className="l-mock-row">
                    <div>
                    ...
                    <div>
                      <span className="l-sc l-sc-m">76점</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="l-cta-wrap">
          <div className="l-cta-inner">
            <div className="l-cta-copy">
              <h3>지금 바로 시작하세요</h3>
              <p>
                조직 계정으로 로그인하면 즉시 사용 가능합니다. 별도 설치 불필요.
              </p>
            </div>
        ...
        <footer className="l-footer">
          <div className="l-foot-left">
            &copy; 2026 Proposal Coworker &middot; TENOPA 사내 플랫폼 &middot;
            외부 공유 금지
          </div>
