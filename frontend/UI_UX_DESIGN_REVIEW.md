...
```css
/* Dark Mode (기본) */
--bg: #0f0f0f /* 배경 */ --surface: #111111 /* 2차 표면 */ --card: #1c1c1c
  /* 카드 */ --border: #262626 /* 테두리 */ --text: #ededed /* 텍스트 */
  --muted: #8c8c8c /* 음소거 텍스트 */ --accent: #3ecf8e /* 강조색 (초록색) */;
```
...
```css
--z-dropdown: 50 --z-modal: 60 --z-overlay: 70 --z-toast: 80;
```
