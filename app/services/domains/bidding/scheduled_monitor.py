...
async def daily_g2b_monitor() -> dict:
    ...
    from app.services.core.notification_service import (
    ...
    if pipeline_targets:
        try:
            from app.services.domains.bidding.bid_pipeline import run_pipeline
...
async def send_daily_summary_email() -> int:
    ...
    try:
        ...
        from app.services.core.email_service import build_email_html, send_email_batch
        body = (
...
def setup_scheduler() -> None:
    ...
    try:
        ...
        from app.services.domains.proposal.prompt_tracker import periodic_maintenance
        scheduler.add_job(
