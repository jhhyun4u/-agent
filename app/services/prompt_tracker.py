...
async def periodic_maintenance() -> dict:
    ...
    try:
        from app.utils.supabase_client import get_async_client
        from app.services.prompt_evolution import evaluate_experiment, promote_candidate, rollback_experiment
    ...
    if attention:
        try:
            from app.services.prompt_evolution import suggest_improvements, create_candidate, start_experiment
