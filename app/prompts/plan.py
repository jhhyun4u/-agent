...
5. **예산 서술(Budget Narrative)**: 각 비용 항목이 어떤 수행 활동을 지원하는지 연결하여 정당화하세요. "왜 이 비용이 필요한가"를 발주기관 관점에서 설명하세요.
...
{{
  "bid_price": {{
    ...
    "budget_narrative": [
      {{"cost_item": "비용 항목명", "linked_activity": "지원하는 수행 활동", "justification": "필요성 근거"}}
    ]
  }}
}}
"""
