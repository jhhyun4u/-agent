...
## Key Nodes
- **PriceScoreCalculator** (C:\project\tenopa proposer\app\services\bidding\pricing\price_score.py) -- 7 connections
  - -> contains -> [[calculate]]
  ...
  - <- contains <- [[pricescore]]
- **_calculate_rfp_formula** (C:\project\tenopa proposer\app\services\bidding\pricing\price_score.py) -- 7 connections
...
- **_calculate_standard** (C:\project\tenopa proposer\app\services\bidding\pricing\price_score.py) -- 6 connections
  - -> calls -> [[unresolvedrefcheckdisqualification]]
  ...
  - -> calls -> [[unresolvedrefpricescoreresult]]
  - <- contains <- [[pricescorecalculator]]
- **calculate** (C:\project\tenopa proposer\app\services\bidding\pricing\price_score.py) -- 6 connections
  - -> calls -> [[unresolvedrefpricescoreresult]]
...
- **__unresolved__::ref::_calculate_rfp_formula** () -- 1 connections
  - <- calls <- [[calculate]]
- **_check_disqualification** (C:\project\tenopa proposer\app\services\bidding\pricing\price_score.py) -- 1 connections
  - <- contains <- [[pricescorecalculator]]
...
- PriceScoreCalculator -> contains -> _estimate_min_bid (-> [[unresolvedrefget-unresolvedrefexecute]])
- PriceScoreCalculator -> contains -> simulate_score_table (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_rfp_formula -> calls -> __unresolved__::ref::get (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_rfp_formula -> calls -> __unresolved__::ref::min (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_rfp_formula -> calls -> __unresolved__::ref::round (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_standard -> calls -> __unresolved__::ref::strip (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_standard -> calls -> __unresolved__::ref::min (-> [[unresolvedrefget-unresolvedrefexecute]])
- _calculate_standard -> calls -> __unresolved__::ref::round (-> [[unresolvedrefget-unresolvedrefexecute]])
- calculate -> calls -> __unresolved__::ref::get (-> [[unresolvedrefget-unresolvedrefexecute]])
