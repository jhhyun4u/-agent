...
class TestProposalWorkflowE2E:
    ...
    async def test_proposal_section_writing_with_harness(self):
        ...
        state = ProposalState(
            ...
            proposal_story={
                ...
                "technical_approach": "Test tech approach",
            },
            rfp={
                "title": "Test RFP",
                "domain": "Technology",
        ...
        with patch('app.graph.nodes.harness_proposal_write.HarnessProposalGenerator') as MockGen:
            ...
            assert mock_gen.generate_section.called
    ...
    def test_harness_cost_efficiency(self):
        ...
        print(f"✓ Harness meets cost targets: 55% savings, 66% time improvement")
    ...
    async def test_complete_proposal_cycle(self):
        ...
        state = ProposalState(
            ...
            # Simulate having gone through STEP 1-3
            rfp={
                "title": "Test RFP",
                "domain": "Technology",
